<a href="<?=base_url('dashboard')?>" class="logo">
    ...
    <span class="logo-lg"><b>Maybank</b></span>
</a>
            ...
            <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="user-footer">
                        <div class="pull-left">
                            <a href="<?=base_url()?>admin/users/edit/<?=$user->id?>" class="btn btn-default btn-flat">
                                <?=$this->ion_auth->is_admin() ? "Edit Profile" : "Ganti Password" ?>
                            </a>
                        </div>
                        <div class="pull-right">
                            <a href="<?=base_url("admin/auth/logout")?>" id="logout" class="btn btn-default btn-flat">Logout</a>
                        </div>
                    </li>
                </ul>
            </li>
