<div class="row">
    <div class="col-sm-12">
        <?= form_open_multipart('admin/insight/save', array('id' => 'forminsight'), array('method' => 'add')); ?>
        <div class="box">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="insight_title" id="insight_title" placeholder="Title">
                            <small class="help-block"></small>
                        </div>

                        <div class="form-group">
                            <label for="photo" class="control-label">Content</label>
                            <textarea name="insight_content" id="mytextarea" cols="30" rows="10"></textarea>
                            <small class="help-block"></small>
                        </div>
                        <!-- <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="insight_date" id="insight_date" placeholder="Link">
                            <small class="help-block"></small>
                        </div>
